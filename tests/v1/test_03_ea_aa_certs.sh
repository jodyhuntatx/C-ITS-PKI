#!/usr/bin/env bash
# Test 03 — EA and AA Subordinate CA Certificates (Profiles 7.2, 7.3 — ETSI TS 103 097 V1.2.1)
# Covers: FR-CI-02, FR-CI-03, AC-02, AC-03

source "$(dirname "$0")/helpers.sh"
echo -e "${BOLD}Test 03 — EA and AA Certificates (Profiles 7.2, 7.3)${NC}"
...
section "FR-CI-02: EA certificate (Profile 7.2)"
...
assert_python_ok "EA has encryptionKey (profile 7.2 requirement)" "
from src.crypto import generate_keypair
from src.types import PublicKeyAlgorithm, EtsiVersion
from src.certificates import issue_root_ca_certificate, issue_ea_certificate
rca_priv, rca_pub = generate_keypair(PublicKeyAlgorithm.ECDSA_NIST_P256)
...
section "FR-CI-03: AA certificate (Profile 7.3)"
...
assert_python_ok "AA has encryptionKey (profile 7.3 requirement)" "
from src.crypto import generate_keypair
from src.types import PublicKeyAlgorithm, EtsiVersion
from src.certificates import issue_root_ca_certificate, issue_aa_certificate
rca_priv, rca_pub = generate_keypair(PublicKeyAlgorithm.ECDSA_NIST_P256)
