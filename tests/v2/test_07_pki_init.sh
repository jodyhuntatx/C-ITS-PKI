#!/usr/bin/env bash
# Test 07 — Full PKI Hierarchy Initialisation via CLI (ETSI TS 103 097 V2.2.1)
...
pki = CITSPKI(algorithm=PublicKeyAlgorithm.ECDSA_NIST_P256, region_ids=[65535], version=EtsiVersion.V2_2_1)
...
from src.pki import CITSPKI
from src.types import PublicKeyAlgorithm, EtsiVersion
pki = CITSPKI(algorithm=PublicKeyAlgorithm.ECDSA_NIST_P256, version=EtsiVersion.V2_2_1)
pki.initialise()
